...
function ContactMap(props){
    ...
    let mapCenter = myContact.map
    let zoom = 3
    let markerPosition = myContact.marker
    let country = myContact.country
    let city = myContact.city
    ...
    return <div id="contact_map" className="contact_box shadow_convex">
