...
function irregular_verbs_game(id){
	...
	this.main_structure = function(id){
		$("#"+id).empty();
		$("#"+id).append('<div class="row"><div class="col-sm-12 title_box"><h1 class="text-center text-uppercase"><span id="verbele_neregulate_titlu">Verbele neregulate</span></h1></div></div>');	
		$("#"+id).append('<div class="quiz_verb_group_container"><div class="row"><div class="col-sm-12"><ul class="quiz_verb_group"><li>A, B</li><li>C, D</li><li>E, F</li><li>G, H</li><li>K, L</li><li>M, P, Q, R</li><li>S</li><li>T, U, W</li></ul></div></div></div>');	
	}
}
